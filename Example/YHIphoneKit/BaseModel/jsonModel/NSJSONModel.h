...
/*
 NSJSONModel是json model的基类，其存在的作用是实现model属性和json之间的映射，以及自动设置等工作，使得上层model只需要声明其属性，而无需知道这些属性如何进行设置的。
...
@class NSJSONModelProperty;
@class NSJSONModelError;

@interface NSJSONModel : NSObject
...
+ (NSJSONModelProperty *)modelKeyMapper;
